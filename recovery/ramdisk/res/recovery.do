...
# Make reboot reason history
    touch -f /efs/recovery/reboot_history

    echo " <reboot_reason> " >> /efs/recovery/reboot_history

    echo "-" >> /efs/recovery/reboot_history
    cp -y -f -v /efs/recovery/reboot_history /cache/recovery/last_reboot_history
    chown -f system system /cache/recovery/last_reboot_history
...
# @IQI(s2.patil, MNO) : delete IQI IQAgent.apk in outbound permanent BYOD scenario(request by SW PL(eunhee78) [
    rm -rf /system/app/IQAgent
#   ]
